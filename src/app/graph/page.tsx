...
export default async function StatsPage() {
  ...
  // Maps Firestore data to the format LineGraph expects
  const entries = snapshot.docs.map((doc) => ({
    id: doc.id,
    ...doc.data(),
  }));

  // Transform data for the LineGraph from Firestore entries
  ...
  return (
    ...
    >
      <div
        className="h-56 flex flex-col items-center justify-center pt-3.5"
        style={{
          color: COLORS.bg5,
      ...
      >
        ...
        <p className="text-lg" style={{ color: COLORS.bg5 }}>
          Visualize your health and habits!
        </p>
      </div>
            ...
            <div className="mt-2">
              <ul className="list-disc ml-6">
                ...
                <li>
                  ...
                  <b>Sleep</b>
                  <br />
                  Studies prove that people with good sleep quality were found to consume higher carbohydrate, fiber,
                ...
                <li>
                  ...
                  <b> Mood</b>
                  <br />
                  Mood was found to deteriorate with poor sleep quality, and can make people become more irritable, tense, and depressed. Feelings of calmness
                ...
                <li>
                  ...
                  <b>Mood</b>
                  <br />
                  Exercising for just 10 additional minutes at an aerobic level can improve vigor, decrease fatigue, and decrease negative mood states.
